...
HD_PWD='C:/Users/230278M/Lab_3_notFinished/Lab_3_notFinished.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FA.tcl -notrace
