...
HD_PWD='C:/Users/230278M/Lab_3_notFinished/Lab_3_notFinished.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA.tcl
