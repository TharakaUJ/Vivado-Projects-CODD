...
HD_PWD='C:/Users/230278M/Lab 1/Lab 1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_1.tcl -notrace
